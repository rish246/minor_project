...
def load_pan_data(xmls_directory, truth_path, write_to_txt_files=False, txts_destination_directory=None):
    ...
    *sorted()* returns a new sorted list (in ascending lexicographical order) of all the items in an iterable.
    '''
    logger.info(f'XMLS Directory : {xmls_directory}')
...
def split_train_and_test_files(author_ids_train, author_ids_test, truths_train, truths_test, preset_key):
    ...
    PRESETS_DICTIONARY = {'PAN18_English': {'dataset_name': 'PAN 2018 English',
                                            'xmls_source_directory': 'data/pan18-author-profiling-training-dataset-2018-02-27/',
    ...
    TRAIN_DESTINATION_MAIN_DIR = "data/pan18-author-profiling-training-dataset-2018-02-27/Training"
    TEST_DESTINATION_MAIN_DIR = "data/pan18-author-profiling-test-dataset-2018-02-27/Test"
...
if __name__ == "__main__":
    ...
    load_pan_data("../data/pan18-author-profiling-training-dataset-2018-02-27/en/text", "../data/pan18-author-profiling-training-dataset-2018-02-27/en/en.txt", write_to_txt_files=False, txts_destination_directory="")
